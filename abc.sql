...
SELECT REPORT_ID,
	...
	EXP_CLST_COUNTRY_CODE || '_' || BASELINE_PARENT_EXPENSE_TYPE AS EXP_TIER_7,EXP_CLST_REGION || '_' || BASELINE_PARENT_EXPENSE_TYPE AS EXP_TIER_8,EXP_CLST_GEO || '_' || BASELINE_PARENT_EXPENSE_TYPE AS EXP_TIER_9,
