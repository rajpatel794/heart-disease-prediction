	...
	WITH ATT AS (
		...
		EXP_TIER AS (
			SELECT EXP.REPORT_ID,
				...
				COALESCE(VENDOR_CITY_LOCATION, EXP.EXPENSE_ID) AS VENDOR_CITY_LOCATION,COALESCE(COALESCE(TRIM(UPPER(MERCHANT_COUNTRY_CODE)), TRIM(UPPER(EXP_CLST.COUNTRY_CODE))), TRIM(UPPER(EMP.COUNTRY_CODE))) AS MERCHANT_COUNTRY_CODE,
